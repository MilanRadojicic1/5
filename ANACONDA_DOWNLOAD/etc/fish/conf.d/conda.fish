set -gx CONDA_EXE (cygpath "C:/ANACONDA_DOWNLOAD\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "C:/ANACONDA_DOWNLOAD")
set _CONDA_EXE (cygpath "C:/ANACONDA_DOWNLOAD\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "C:/ANACONDA_DOWNLOAD\python.exe")
